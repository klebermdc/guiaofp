...
export const restaurantsData: Restaurant[] = [
  ...
  },
  {
    ...
    name: 'Adega Gaúcha Orlando',
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '8434 International Dr, Orlando, FL 32819',
    phone: '(407) 440-2747',
    description: 'Moderna churrascaria brasileira com carnes grelhadas na brasa. Mesa gourmet com legumes frescos, saladas e carpaccio. Autêntico estilo gaúcho.',
    priceRange: '$$$',
    highlights: [
      'Churrasco gaúcho autêntico',
      'Carnes de primeira',
      'Mesa gourmet',
      'Ambiente moderno',
    ...
    website: 'https://adegagaucha.com',
    reservations: true
  },
  {
    id: 'adega-gaucha-kissimmee',
    name: 'Adega Gaúcha Kissimmee',
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '5550 W Irlo Bronson Memorial Hwy, Kissimmee, FL 34746',
    phone: '(407) 507-1001',
    description: 'Filial de Kissimmee da Adega Gaúcha. Mesma qualidade e tradição gaúcha em localização conveniente próxima aos hotéis.',
    priceRange: '$$$',
    highlights: [
      'Localização Kissimmee',
      'Rodízio completo',
      'Mesa gourmet',
      'Ótimo para grupos',
      'Próximo aos hotéis'
  ...
  },
  {
    ...
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '9101 International Dr, Ste 1220, Pointe Orlando, FL 32819',
    phone: '(407) 593-4422',
    description: 'Primeira churrascaria brasileira da América. Localizada no Pointe Orlando. Salad bar premiado e carnes saborosas. Ótima para eventos corporativos.',
    priceRange: '$$$',
    highlights: [
      'Primeira churrascaria dos EUA',
      'Salad bar premiado',
      'No Pointe Orlando',
      'Ótimo para grupos',
      'Ambiente autêntico'
    ...
    menu: {
      mainCourses: [
        'Carnes grelhadas variadas',
        'Frango',
        'Linguiça',
        'Costela',
        'Picanha',
        'Sides tradicionais brasileiros'
      ]
    },
    images: ['https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=800'],
    website: 'https://rodziogrill.com',
    reservations: true
  },
  {
    id: 'boibrazil',
    name: 'BoiBrazil Churrascaria',
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '5668 International Dr, Orlando, FL 32819',
    phone: '(407) 603-3600',
    description: 'Churrascaria autêntica com seleção infinita de carnes grelhadas. Salad bar gourmet com mais de 30 itens. Pão de queijo tradicional brasileiro.',
    priceRange: '$$$',
    highlights: [
      'Rodízio infinito',
      'Salad bar com 30+ itens',
      'Pão de queijo artesanal',
      'Carnes temperadas com alho e parmesão',
      'Serviço atencioso'
    ],
    menu: {
      mainCourses: [
  ...
  {
    id: 'divina-carne',
    name: 'Divina Carne Orlando',
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '6424 Carrier Dr, Orlando, FL 32819',
    phone: '(407) 778-7600',
    description: 'Steakhouse brasileira de luxo próxima à International Drive. Vencedora do Wine Spectator Award of Excellence. Estação de massas única.',
    priceRange: '$$$$',
    highlights: [
    ...
    images: ['https://images.unsplash.com/photo-1544025162-d76694265947?w=800'],
    website: 'https://divinacarneusa.com',
    reservations: true
  },
  {
    id: 'cafe-mineiro',
    name: 'Cafe Mineiro Brazilian Steakhouse',
    category: 'fora-parques',
    subcategory: 'Churrascaria',
    address: '6232 International Dr, Orlando, FL 32819',
    phone: '(407) 248-2932',
    description: 'Churrascaria brasileira com atmosfera familiar aconchegante. Carnes defumadas em churrasco autêntico. Buffet com pratos típicos, incluindo feijoada.',
    priceRange: '$$',
    highlights: [
      'Ambiente familiar',
      'Até 12 cortes diferentes',
    ...
    images: ['https://images.unsplash.com/photo-1544025162-d76694265947?w=800'],
    website: 'https://cafemineirosteakhouse.us',
    reservations: true
  },
  ...
  // JAPONÊS
  {
    ...
    phone: '(407) 960-8838',
    description: 'Experiência omakase de alto nível com 2 estrelas Michelin. Apenas 10 lugares. Menu muda mensalmente com foco em produtos da Flórida. Benjamin Coutts ganhou Sommelier do Ano Michelin 2023.',
    priceRange: '$$$$',
    highlights: [
      '2 Estrelas Michelin',
    ...
    menu: {
      mainCourses: [
        ...
        'Harmonização de saquês e coquetéis'
      ]
    },
    images: ['https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=800'],
  ...
  },
  {
    ...
    subcategory: 'Japonês',
    address: '426 Plant St, Winter Park, FL 32789',
    description: 'Sake lounge irmão do Soseki. Ambiente íntimo com seleção premium de saquês. Pequenos pratos japoneses criativos.',
    priceRange: '$$$',
    highlights: [
      'Irmão do Soseki',
      'Sake lounge premium',
  ...
  },
  {
    ...
    category: 'fora-parques',
    subcategory: 'Japonês',
    address: '426 S Plant St, Market #19/20, Orlando, FL 32801',
    description: 'Mistura tradição japonesa com toque moderno urbano. Jazz e música relaxante. Ambiente descolado e elegante.',
    priceRange: '$$',
    highlights: [
      'Música jazz ao vivo',
      'Ambiente urbano',
  ...
  },
  {
    ...
    category: 'fora-parques',
    subcategory: 'Japonês',
    address: '1911 E 7th Ave, Tampa, FL 33605',
    description: 'Ramen house artesanal com macarrão caseiro. Terceiro Michelin Bib Gourmand. Pequenos pratos criativos. Happy hour com Wasabi Ginger Margarita.',
    priceRange: '$$',
    highlights: [
  ...
  },
  {
    ...
    description: 'Buffet americano all-you-can-eat. Grande variedade de carnes, acompanhamentos, saladas e sobremesas. Ótimo custo-benefício para famílias.',
    priceRange: '$',
    highlights: [
      'Buffet infinito',
      'Ótimo custo-benefício',
    ...
    menu: {
      ...
      desserts: ['Soft-serve ice cream', 'Bolos', 'Tortas']
    },
    images: ['https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800'],
    reservations: false
  },
  {
    ...
    subcategory: 'Americano',
    address: 'Várias localizações em Orlando',
    description: 'Famoso pelas panquecas tradicionais americanas. Café da manhã o dia todo. Menu com opções americanas para almoço e jantar também.',
    priceRange: '$',
    highlights: [
      'Panquecas famosas',
  ...
  },
  {
    ...
    subcategory: 'Americano',
    address: 'Várias localizações em Orlando',
    description: 'Comida caseira do sul dos EUA. Loja country anexa ao restaurante. Café da manhã, almoço e jantar. Ambiente rústico acolhedor.',
    priceRange: '$',
    highlights: [
      'Comida caseira do sul',
      'Loja country',
      'Café da manhã tradicional',
      'Ambiente rústico',
      'Varanda com cadeiras de balanço'
    ],
    menu: {
      mainCourses: [
        'Chicken n\' Dumplin\'s',
  ...
  },
  {
    ...
    category: 'fora-parques',
    subcategory: 'Americano',
    address: 'Várias localizações em Orlando - muitas 24h',
    description: 'Diner americano clássico aberto 24 horas. Café da manhã servido o dia todo. Grand Slam breakfast famoso. Preços acessíveis.',
    priceRange: '$',
    highlights: [
      'Aberto 24 horas',
  ...
  },
  {
    ...
    subcategory: 'Italiano',
    address: 'Várias localizações em Orlando',
    description: 'Culinária italiana com toque contemporâneo. Massas, frutos do mar e carnes grelhadas. Pratos para compartilhar.',
    priceRange: '$$',
    highlights: [
      'Culinária italiana autêntica',
      'Massas frescas',
      'Chicken Bryan famoso',
      'Pratos para dividir',
      'Bom para famílias'
    ],
    menu: {
  ...
  },
  {
    ...
    category: 'fora-parques',
    subcategory: 'Italiano',
    address: '7780 W Sand Lake Rd, Orlando, FL 32819',
    phone: '(407) 239-2822',
    description: 'Restaurante italiano estilo familiar com pratos grandes para compartilhar. Decoração autêntica italiana. No Florida Mall.',
    priceRange: '$$',
    highlights: [
      'Pratos família (servem 3 pessoas)',
      'Decoração italiana',
      'Ótimo para grupos',
      'Preço $25-35 por prato grande',
      'No Florida Mall'
    ],
    menu: {
      mainCourses: [
        'Spaghetti & Meatballs (família)',
        'Chicken Parmigiana (família)',
        'Lasagna (família)',
        'Fettuccine Alfredo (família)'
      ]
    },
    images: ['https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=800'],
    reservations: true
  ...
  // MEXICANO
  {
    ...
    category: 'fora-parques',
    subcategory: 'Mexicano',
    address: 'Várias localizações em Orlando',
    description: 'Fast-casual mexicano com burritos, tacos e bowls customizáveis. Guacamole grátis. Ambiente casual e divertido.',
    priceRange: '$',
    highlights: [
      'Guacamole grátis',
      'Customizável',
  ...
  },
  {
    ...
    subcategory: 'Mexicano',
    address: 'Várias localizações em Orlando',
    description: 'Rede local da Flórida de comida Tex-Mex. Hot sauce bar com mais de 30 molhos. Preços acessíveis e porções generosas.',
    priceRange: '$',
    highlights: [
      'Rede local da Flórida',
      'Hot sauce bar (30+ molhos)',
      'Preços baixos',
      'Porções grandes',
      'Ambiente casual'
    ],
  ...
  },
  {
    ...
    subcategory: 'Frutos do Mar',
    address: 'Várias localizações em Orlando',
    description: 'Frutos do mar frescos com preparações contemporâneas. Bang Bang Shrimp famoso. Ambiente sofisticado mas casual.',
    priceRange: '$$',
    highlights: [
      'Bang Bang Shrimp icônico',
      'Peixes frescos',
  ...
  // ASIÁTICO / CHINÊS
  {
    ...
    address: 'Várias localizações incluindo CityWalk',
    description: 'Fast-food de comida chinesa americana. Orange Chicken famoso. Preços acessíveis e pratos generosos.',
    priceRange: '$',
    highlights: [
      'Orange Chicken icônico',
      'Fast-food chinês',
      'Preços baixos',
      'Várias localizações',
      'Porções generosas'
    ...
    images: ['https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=800'],
    reservations: false
  },
  {
    id: 'pf-changs',
  ...
  {
    id: 'sticky-rice',
    name: 'Sticky Rice Lao Street Food',
    category: 'fora-parques',
    subcategory: 'Asiático',
    address: '916 Mills Ave, Orlando, FL 32803',
    description: 'Primeiro restaurante quick-casual de comida laosiana de Orlando. Comida de rua autêntica. Encoraja comer com as mãos.',
    priceRange: '$',
    highlights: [
      'Comida laosiana autêntica',
      'Comer com as mãos',
      'Preços acessíveis',
      'Menu educativo',
      'Sobremesa de arroz roxo'
    ],
    menu: {
      mainCourses: [
        'Laab rice bowl',
      ...
      desserts: ['Sweet purple rice with mango']
    },
    images: ['https://images.unsplash.com/photo-1580959375944-0c4a7b6aa850?w=800'],
    reservations: false
  },
  ...
  },
  {
    ...
    phone: '(407) 239-4700',
    description: 'Restaurante do chef celebrity Richard Blais (Top Chef). No Hyatt Regency Grand Cypress. Culinária da Flórida com twist moderno.',
    priceRange: '$$$',
    highlights: [
      'Chef Richard Blais',
      'Culinária da Flórida',
      'Ingredientes locais',
      'No Hyatt Regency',
      'Menu criativo'
    ],
  ...
  },
  {
    ...
    name: 'Se7en Bites',
    category: 'fora-parques',
    subcategory: 'Bakery/Comfort Food',
    address: '617 N Primrose Dr, Orlando, FL 32803',
    phone: '(407) 203-7934',
    description: 'Bakery e café com comida caseira do sul. Famosa pelos bolos e biscoitos. Café da manhã e brunch excepcional.',
    priceRange: '$$',
    highlights: [
      'Bakery artesanal',
      'Comida caseira do sul',
    ...
    menu: {
      ...
      desserts: ['Cakes (vários sabores)', 'Pies', 'Cookies']
    },
    images: ['https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800'],
    reservations: false
  }
